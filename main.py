...
__CHANNEL_USERNAME__ = "galacpmtool"
__GROUP_USERNAME__   = "galacpmtool_chat"
...
def banner(console):
    ...
    brand_name = figlet_format('GALACPMTOOL', font='drpepper')
    colors = [
    ...
    console.print(f"    [bold green]𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𝐁𝐎𝐓 [/bold green]: [bold cyan]@cpmgalabot[/bold cyan] 𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 [bold cyan]@galacpmtool[/bold cyan]") 
    console.print("[bold][red]================================================================[/red][/bold]")
